...
function SignIn() {
  const navigate = useNavigate() //it is used to navigate to other pages on button click or simple click
  ...
  /////////////////////////////////
  useEffect(() => {
    document.title = 'Sign In to our page'; // Set the initial title when the component mounts
  }, []);
  //////////////////////////////////////////////////////
